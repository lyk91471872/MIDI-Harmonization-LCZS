...
def plot_loss_curve(log_history, output_path='loss_curve_lora.png'):
    """
...
def main():
    ...
    with open('train_history_lora.json', 'w') as f:
        json.dump(log_history, f, indent=2)
    print('Saved training history to train_history_lora.json')

    # 12) Plot and save loss curve
    plot_loss_curve(log_history, output_path='loss_curve_lora.png')
    print('Saved loss curve to loss_curve_lora.png')
